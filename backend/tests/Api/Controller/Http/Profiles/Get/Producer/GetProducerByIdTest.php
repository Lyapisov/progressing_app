...
namespace App\Tests\Api\Controller\Http\Profiles\Get\Producer;
...
final class GetProducerByIdTest extends ControllerTestCase
{
    ...
    public function testFanNotFound(): void
    {
        ...
        $this->assertJsonResponse($response, [
           'error' => [
               'messages' => [
                   'Продюсер с идентификатором: 0cf9773e-869d-46d5-a771-1c5f08296c84 не найден.'
               ],
               'code' => 1
           ]
        ]);
